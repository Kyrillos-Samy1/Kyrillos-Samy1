...
I am seeking a **Full Stack Developer position** where I can apply my **+2 year of professional experience in Frontend development** while contributing to scalable backend systems. I am eager to learn, grow, and collaborate with a dynamic team to enhance my expertise in both Frontend and Backend development.
...
| Node.js, Express.js, Nest.js, RESTful API Development | PostgreSQL, TypeORM, MongoDB, Mongoose | JWT & Authentication | Bcrypt, Crypto | Email & Notifications |
|---------------------------------------------|-----------------|--------------------|----------------|--------------------|
| API Testing (Postman) | Payment Integration (Stripe) | File Uploads & Media Hosting (Cloudinary, Multer, Sharp) | Error Handling & Validation (express-validator, sanitize, xss) | Nodemailer, Email Templates |
...
- Focused on React.js, Next.js, Redux, TypeScript, Tailwind CSS, API Integration, and Performance Optimization.
...
- **E-Commerce RESTFull API** – Full-featured backend for an e-commerce platform (Node.js, Express, MongoDB)  
  [![API Docs](https://img.shields.io/badge/API%20Docs-ECommerce_APIs-2E8B57?style=for-the-badge&logo=postman&logoColor=orange&color=orange)](https://documenter.getpostman.com/view/41775437/2sB3WjyP5z#intro)   
